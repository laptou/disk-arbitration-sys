...
fn main() {
    ...
    bindings
        .write_to_file(out_path.join("disk-arbitration.rs"))
        .expect("Couldn't write bindings!");

    std::fs::write(out_path.join("disk-arbitration-extra.rs"), generated_code).unwrap();
}
